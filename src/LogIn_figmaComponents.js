              ...
              <div style={{ "zIndex": 2 }} className="outerDiv centerer">
                ...
                >
                  <div className="vector" dangerouslySetInnerHTML={{
                    __html: `<svg preserveAspectRatio="none" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <div>
              ...
              <div style={{ "zIndex": 2 }} className="outerDiv centerer">
                ...
                >
                  <div className="vector" dangerouslySetInnerHTML={{
                    __html: `<svg preserveAspectRatio="none" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
