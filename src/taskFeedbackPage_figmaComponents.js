...
`}} />
        ...
        <div style={{"zIndex":3}} className="outerDiv centerer">
          <div
            ...
            className="innerDiv"
          >
            <div className="vector" dangerouslySetInnerHTML={{__html: `<svg preserveAspectRatio="xMidYMid" width="92" height="40" viewBox="0 0 92 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <div>
              ...
              <div style={{"zIndex":3}} className="outerDiv">
                <div
                  id="49:27"
                  style={{"marginLeft":158,"width":141,"minWidth":141,"height":null,"marginTop":-40,"marginBottom":0,"minHeight":40,"backgroundColor":"rgba(58, 21, 127, 1)","borderRadius":"20px 20px 20px 20px"}}
                  className="innerDiv"
                >
                  <div>
                  <div
              ...
              <div style={{"zIndex":1}} className="outerDiv">
                <div
                  id="49:26"
                  style={{"marginLeft":12,"width":126,"minWidth":126,"height":null,"marginTop":-33,"marginBottom":8,"minHeight":25,"color":"rgba(255, 255, 255, 1)","fontSize":18,"fontWeight":500,"fontFamily":"Roboto","textAlign":"LEFT","fontStyle":"normal","lineHeight":"125%","letterSpacing":"0.135px"}}
                  className="innerDiv"
                >
                  <div>
