                  ...
                  <div>
                    <div style={{}} className="outerDiv centerer">
                      <div
                        ...
                        className="innerDiv"
                      >
                        <div className="vector" dangerouslySetInnerHTML={{__html: `<svg preserveAspectRatio="none" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <div style={{"zIndex":1}} className="outerDiv centerer">
                <div
                  ...
                  className="innerDiv"
                >
                  <div className="vector" dangerouslySetInnerHTML={{__html: `<svg preserveAspectRatio="none" width="162" height="2" viewBox="0 0 162 2" fill="none" xmlns="http://www.w3.org/2000/svg">
